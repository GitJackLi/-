...
public class WeightedObservedPointsTest {
     ...
     */
    public WeightedObservedPointsTest(double[] x, double[] y, int n) {
     ...
     * @param n      The order of polynomial
     */
    public WeightedObservedPointsTest(double[] x, double[] y, double[] weight, int n) {
    ...
    public static void main(String[] args) {
        WeightedObservedPointsTest eastSquareMethod = new WeightedObservedPointsTest(
                new double[]{
                        2, 14, 20, 25, 26, 34,
